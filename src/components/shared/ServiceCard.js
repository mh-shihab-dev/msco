...
const ServiceCard = ({service}) => {
    const {id,title,description,darkIcon,lightIcon} = service || {};
  return (
     <div
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="w-14 h-14 rounded-full bg-[#FAF7F2] group-hover:bg-[#B68C5A] flex items-center justify-center mb-4 transition-colors duration-500">
              ...
              <Image
                src={lightIcon}
                alt=""
                className="hidden group-hover:block transition-all duration-500 transform group-hover:scale-x-[-1]"
              />
            </div>
            ...
            {/* Description */}
            <p className="text-[#11c1a] font-inter text-lg  group-hover:text-gray-200 transition-colors duration-500">
              {description}
            </p>
